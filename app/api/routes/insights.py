...
from app.api.insights_client import ExternalInsightsClient, InsightsAPIError
...
def get_insights_client(request: Request) -> ExternalInsightsClient:
    """Retrieve the shared ExternalInsightsClient from app state (set in lifespan)."""
...
async def get_insights(
    ...
    Behavior:
      ...
      • Otherwise, call the external insights API via `ExternalInsightsClient`.
