---
name: azure-security
description: Security-by-default patterns for Azure Infrastructure as Code (Bicep or Terraform). Use when generating Azure infrastructure, writing security requirements in ADRs, or working on compliance-sensitive deployments. Covers Zero Trust, SFI, CAF, AVM, WAF frameworks, managed identities, RBAC, private endpoints, and Azure Verified Modules.
---
